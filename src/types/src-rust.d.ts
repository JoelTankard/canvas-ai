declare module "src-rust" {
    ...
    export function delete_file(api_key: string, file_id: string): Promise<string>;
    ...
    export function process_file(api_key: string, file_id: string, assistant_id: string, thread_id: string): Promise<string>;
